...
import {ThingsRows} from "../partials/ThingsRows"
    ...
    <div className={`card ${className}`}>
      ...
      <div className={`card-header border-0 pt-5 ${innerPadding}`}>
        <h3 className="card-title align-items-start flex-column">
          ...
          <span className="text-muted mt-2 fw-bold fs-6">$8.47 Saved this Month</span>
        </h3>
          ...
          >
            ...
            <div className="table-responsive">
              <table className="table table-borderless align-middle">
                ...
                <tbody>
                 <ThingsRows className="card-stretch mb-5 mb-xxl-8" ></ThingsRows>
